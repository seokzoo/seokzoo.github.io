          ...
          return (
            n.forEach(function (e) {
              ;(e.classList.remove("medium-zoom-image"),
                e.dispatchEvent(a("medium-zoom:detach", { detail: { zoom: j } })))
            }),
            ...
            r = function () {
              ...
              if (T.container)
                if (T.container instanceof Object)
                  ((i = (t = e({}, t, T.container)).width - t.left - t.right - 2 * T.margin),
                    (r = t.height - t.top - t.bottom - 2 * T.margin))
                else {
                  var d = (
                      o(T.container) ? T.container : document.querySelector(T.container)
          ...
          return new c(function (e) {
            if (i && -1 === x.indexOf(i)) e(j)
              ...
              if (k.zoomed) e(j)
                ...
                if (
                  (k.original.dispatchEvent(a("medium-zoom:open", { detail: { zoom: j } })),
                  (S =
                    window.pageYOffset ||
                    document.documentElement.scrollTop ||
                    document.body.scrollTop ||
                ...
                if (
                  ...
                  k.zoomed.addEventListener("transitionend", function t() {
                    ;((A = !1),
                      ...
                      k.original.dispatchEvent(a("medium-zoom:opened", { detail: { zoom: j } })),
                      e(j))
                  }),
                  ...
                  ;((k.zoomedHd = k.zoomed.cloneNode()),
                    ...
                    (k.zoomedHd.onerror = function () {
                      ;(clearInterval(m),
                        console.warn("Unable to reach the zoom image target " + k.zoomedHd.src),
                        (k.zoomedHd = null),
                        r())
                    }))
          ...
          return new c(function (e) {
            if (!A && k.original) {
              ;((A = !0),
                ...
                k.template &&
                  ((k.template.style.transition = "opacity 150ms"), (k.template.style.opacity = 0)),
                k.original.dispatchEvent(a("medium-zoom:close", { detail: { zoom: j } })),
                k.zoomed.addEventListener("transitionend", function t() {
                  ;(k.original.classList.remove("medium-zoom-image--hidden"),
                    ...
                    (A = !1),
                    k.zoomed.removeEventListener("transitionend", t),
                    k.original.dispatchEvent(a("medium-zoom:closed", { detail: { zoom: j } })),
                    (k.original = null),
                    (k.zoomed = null),
                    (k.zoomedHd = null),
                    (k.template = null),
