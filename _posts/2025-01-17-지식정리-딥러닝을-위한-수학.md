...
- probability density function(PDF) : continuous distribution에서 값을 추출할 때 적용되는 확률을 생성하는 함수
	- probability mass function(PMF) : discrete distribution에서 값을 추출할 때 적용되는 확률을 생성하는 함수
